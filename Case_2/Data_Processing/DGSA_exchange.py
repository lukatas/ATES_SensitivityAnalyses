...
for d in directories:
    ...
    for file3 in files3:
        ...
        for s in range(number_of_seasons):
            zoomed_data_Cold = energy.sel(season=int('{}'.format(s)), x=slice(642, 662), y=slice(510, 490))
            zoomed_data_Warm = energy.sel(season=int('{}'.format(s)), x=slice(350, 370), y=slice(510, 490))
