...
from ATES_SensitivityAnalyses.Case_2.Parallel_Simulations.utils import Q_sine
...
for d in directories:
    ...
    for file in files:
        ...
        if directories.index(d) == 0:
            ...
            ]  # to check which rows are duplicates (based on indices)
    ...
    # make dataframe and calculations injected and extracted energy per season
